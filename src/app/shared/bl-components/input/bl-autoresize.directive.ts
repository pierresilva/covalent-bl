...
export class BlAutoResizeDirective implements AfterViewInit, OnDestroy {
  ...
  @Input()
  set blAutosize(value: string | boolean | AutoSizeType) {
  ...
  get blAutosize(): string | boolean | AutoSizeType {
  ...
  ngAfterViewInit(): void {
    if (this.blAutosize && this.platform.isBrowser) {
      if (this.ngControl) {
        ...
        console.warn('blAutosize must work with ngModel or ReactiveForm');
      }
    }
  }
