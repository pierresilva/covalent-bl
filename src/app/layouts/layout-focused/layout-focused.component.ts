...
import { InternalDocsService } from '../layout-components/services';

const NUMBER_FORMAT: (v: any) => any = (v: number) => v;
const DECIMAL_FORMAT: (v: any) => any = (v: number) => v.toFixed(2);

@Component({
  selector: 'app-layout-focused',
  templateUrl: './layout-focused.component.html',
  styleUrls: ['./layout-focused.component.scss'],
  preserveWhitespaces: true,
})
export class LayoutFocusedComponent implements OnInit {
